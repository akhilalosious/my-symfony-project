...
class FrontController extends AbstractController
{
    ...
    public function videoList($id, CategoryTreeFrontPage $categories): Response
    {
        ...
        //$subCategories = $catyegories->buildTree($id);
        // return $this->render('front/video_list.html.twig', [
        //     'subcategories' => $catyegories->getCategoryList($subCategories)
        // ]);   
        return $this->render('front/video_list.html.twig', [
    ...
    {
        $catyegories = $this->getDoctrine()->getRepository(Category::class)->findBy(['parent'=>null], ['name'=>'ASC']);
        return $this->render('front/_main_categories.html.twig', [
            'categories'=>$catyegories
        ]);
    }
}
